        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section className="pt-8 border-t border-slate-100">
            <p className="text-sm text-slate-400">
              Para consultas sobre sus datos, puede contactarnos a: <a href="mailto:notificaciones@centrodebelleza.com.ar" className="text-[--seasonal-primary] hover:underline">notificaciones@centrodebelleza.com.ar</a>
            </p>
